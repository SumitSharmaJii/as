...
app.post("/game", (req, res) => {
  const { girlName } = req.body;
  res.render("game", { girlName: girlName || "Player" });
});

app.get("/flappy", (req, res) => {
  res.render("flappy", { girlName: "Player" });
});

app.post("/flappy", (req, res) => {
  const { girlName } = req.body;
  res.render("flappy", { girlName: girlName || "Player" });
});
